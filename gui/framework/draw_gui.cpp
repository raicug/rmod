...
void framework::gui::draw(TextEditor & editor) {
                    ...
                    switch (custom.m_visuals_subtab) {
                        case 0: // FOV
                                                                 ...
                                                                 GetWindowHeight()));
                            {
                                ...
                                ColorEdit4("##color", reinterpret_cast<float*>(&raicu::globals::settings::other::fovColor), ALPHA);
                        ...
                        case 1: // Crosshair
                                                                 ...
                                                                 GetWindowHeight()));
                            {
                                ...
                                SameLine(GetWindowWidth() - 33);
                                ColorEdit4("##color_main", reinterpret_cast<float*>(&raicu::globals::settings::crosshairValues::color), ALPHA);

                                Checkbox("Outlined", &raicu::globals::settings::crosshairValues::outlineEnabled);
                                SameLine(GetWindowWidth() - 33);
                                ColorEdit4("##color_outline", reinterpret_cast<float*>(&raicu::globals::settings::crosshairValues::outlineColor), ALPHA);
                            }
                            custom.end_child();
                            ...
                            custom.begin_child("Values", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2,
                                                                 GetWindowHeight())); {
                                SliderFloat("Outline Thickness", &raicu::globals::settings::crosshairValues::outlineThickness, 0, 10, "%.2f");
                                SliderFloat("Rounding", &raicu::globals::settings::crosshairValues::rounding, 0, 10, "%.2f");
                                SliderFloat("Width", &raicu::globals::settings::crosshairValues::width, 0.1, 100, "%.2f");
                                SliderFloat("Height", &raicu::globals::settings::crosshairValues::height, 0.1, 100, "%.2f");
                                SliderFloat("Offset", &raicu::globals::settings::crosshairValues::offset, -100, 100, "%.2f");
                            }
                            custom.end_child();
                        ...
                        case 2: // ESP
                                                                 ...
                                                                 GetWindowHeight()));
                            {
                                ...
                                Checkbox("Box", &raicu::globals::settings::espValues::box); SameLine(GetWindowWidth() - 33); ColorEdit4("##Boxcolor", reinterpret_cast<float *>(&raicu::globals::settings::espValues::boxColor), ALPHA);
                                Checkbox("Origin", &raicu::globals::settings::espValues::origin); SameLine(GetWindowWidth() - 33); ColorEdit4("##Origincolor", reinterpret_cast<float *>(&raicu::globals::settings::espValues::originColor), ALPHA);
                                Checkbox("Name", &raicu::globals::settings::espValues::name); SameLine(GetWindowWidth() - 33); ColorEdit4("##Namecolor", reinterpret_cast<float *>(&raicu::globals::settings::espValues::nameColor), ALPHA);
                                Checkbox("Snapline", &raicu::globals::settings::espValues::snapline); SameLine(GetWindowWidth() - 33); ColorEdit4("##Snaplinecolor", reinterpret_cast<float *>(&raicu::globals::settings::espValues::snapLineColor), ALPHA);
                                Combo("Snapline Position", &raicu::globals::settings::espValues::snaplinePosition, custom.snaplinePosition, IM_ARRAYSIZE(custom.snaplinePosition));
                            }
                            custom.end_child();
                        ...
                        case 3: // CHAMS
                            custom.begin_child("General##4", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                                Checkbox("Enable", &raicu::globals::settings::chams::enabled); SameLine(GetWindowWidth() - 33); ColorEdit4("##PlayerColor", reinterpret_cast<float *>(&raicu::globals::settings::chams::playerColor), ALPHA);
                                ...
                                Combo("Material##1", &raicu::globals::settings::chams::material_type, custom.materialList, IM_ARRAYSIZE(custom.materialList));
                            }
                            custom.end_child();

                            SameLine();

                            custom.begin_child("View Model##1", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                                Checkbox("Enabled", &raicu::globals::settings::chams::localplr::hands); SameLine(GetWindowWidth() - 33); ColorEdit4("##HandsColor", reinterpret_cast<float *>(&raicu::globals::settings::chams::localplr::hands_color), ALPHA);
                                Combo("Material##3", &raicu::globals::settings::chams::localplr::hands_material_type, custom.materialList, IM_ARRAYSIZE(custom.materialList));
                            }
                            custom.end_child();
                    ...
                    case 0: // Main
                        custom.begin_child("General##1", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2,
                                                             GetWindowHeight()));
                            {
                                ...
                                Checkbox("Enable logging notifications", &raicu::globals::settings::loggerNotifications);

                            }
                            custom.end_child();
                            SameLine();
                            custom.begin_child("Console Colors##2", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                                Text("INFO Color"); SameLine(GetWindowWidth() - 33); ColorEdit4("##infocol", reinterpret_cast<float*>(&raicu::globals::settings::consoleLogColours::infoColor), ALPHA);
                                Text("WARNING Color"); SameLine(GetWindowWidth() - 33); ColorEdit4("##warningcol", reinterpret_cast<float*>(&raicu::globals::settings::consoleLogColours::warningColor), ALPHA);
                                Text("ERROR Color"); SameLine(GetWindowWidth() - 33); ColorEdit4("##errorcol", reinterpret_cast<float*>(&raicu::globals::settings::consoleLogColours::errorColor), ALPHA);
                                Text("FATAL Color"); SameLine(GetWindowWidth() - 33); ColorEdit4("##fatalcol", reinterpret_cast<float*>(&raicu::globals::settings::consoleLogColours::fatalColor), ALPHA);
                                Text("SUCCESS Color"); SameLine(GetWindowWidth() - 33); ColorEdit4("##successcol", reinterpret_cast<float*>(&raicu::globals::settings::consoleLogColours::successColor), ALPHA);
                                Text("UNKNOWN Color"); SameLine(GetWindowWidth() - 33); ColorEdit4("##unknowncol", reinterpret_cast<float*>(&raicu::globals::settings::consoleLogColours::unknownColor), ALPHA);
                            }
                            custom.end_child();
            ...
            case 3: // Configs
                ...
                BeginChild("##config_childs", ImVec2(GetWindowWidth() - 80, GetWindowHeight() - 80));
                {
                    switch (custom.m_config_subtab) {
                        case 0: // Main
                            custom.begin_child("General##1", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                        {
                            TextDisabled("Disabled for now");
                        }
                ...
                BeginChild("##world_childs", ImVec2(GetWindowWidth() - 80, GetWindowHeight() - 80));
                {
                    switch (custom.m_world_subtab) {
                        case 0: // Aimbot
                            custom.begin_child("General##1", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                                Checkbox("Enabled", &raicu::globals::settings::aimbot::enabled); raicu::gui::other::hotkey("Aimbot", &raicu::globals::settings::aimbot::hotkey);
                                ...
                                Combo("Hitbox", &raicu::globals::settings::aimbot::hitbox, custom.aimbot_hitboxes, IM_ARRAYSIZE(custom.aimbot_hitboxes));
                                Combo("Priority", &raicu::globals::settings::aimbot::priority, custom.aimbot_priorities, IM_ARRAYSIZE(custom.aimbot_priorities));
                            }
                            custom.end_child();
                            SameLine();

                            custom.begin_child("Accuracy + Backtrack", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                                ...
                                Separator();
                                Checkbox("Enable", &raicu::globals::settings::aimbot::backtrackEnabled); SameLine(GetWindowWidth() - 33); ColorEdit4("##backtrackColor", reinterpret_cast<float*>(&raicu::globals::settings::aimbot::backtrackColor), NO_ALPHA);
                                SliderFloat("Backtrack", &raicu::globals::settings::aimbot::backtrack, 0, 1, "%.2f ms");
                                Combo("Material", &raicu::globals::settings::aimbot::backtrackMaterial, custom.materialList, IM_ARRAYSIZE(custom.materialList));
                            }
                            custom.end_child();

                            break;
                        case 1: // Movement
                            custom.begin_child("General##2", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                            ...
                            break;
                        case 2: // Players
                            custom.begin_child("Main##4", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                                ...
                                InputTextWithHint("Search", "Search for player", search_buffer, IM_ARRAYSIZE(search_buffer));
                            ...
                            custom.end_child();
							SameLine();
                            custom.begin_child("Players##4", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
								player_info_t pinfo;
												...
												if (strlen(pinfo.name) > 0) {
													...
													if (BeginPopupContextItem(display_name.c_str())) {
													    ...
													    if (ImGui::Selectable("Whitelist player", is_whitelisted)) {
                                                            if (is_whitelisted) {
                                                                if (raicu::globals::settings::whitelist.contains("players")) {
                                                                    auto &players = raicu::globals::settings::whitelist["players"];
                                                                    players.erase(
                                                                ...
                                                                if (!raicu::globals::settings::whitelist.contains("players")) {
                                                                    raicu::globals::settings::whitelist["players"] = nlohmann::json::array();
                                                                }
                                                                ...
                                                                raicu::globals::settings::whitelist["players"].push_back(player_entry);
                                                            }
                                                        }
                                                        ...
                                                        if (ImGui::Selectable("Mark player as friend", is_friend)) {
                                                            if (is_friend) {
                                                                if (raicu::globals::settings::friend_list.contains("players")) {
                                                                    auto &friends = raicu::globals::settings::friend_list["players"];
                                                                    friends.erase(
                                                                ...
                                                                if (!raicu::globals::settings::friend_list.contains("players")) {
                                                                    raicu::globals::settings::friend_list["players"] = nlohmann::json::array();
                                                                }
                                                                ...
                                                                raicu::globals::settings::friend_list["players"].push_back(player_entry);
                                                            }
                                                        }
                                                        ...
                                                        if (ImGui::Selectable("Mark player as target", is_target)) {
                                                            if (is_target) {
                                                                if (raicu::globals::settings::target_list.contains("players")) {
                                                                    auto &friends = raicu::globals::settings::target_list["players"];
                                                                    friends.erase(
                                                                        std::remove_if(friends.begin(), friends.end(),
                                                                            [&pinfo](const nlohmann::json &player) {
                                                                                return player["name"] == pinfo.name;
                                                                ...
                                                                if (!raicu::globals::settings::target_list.contains("players")) {
                                                                    raicu::globals::settings::target_list["players"] = nlohmann::json::array();
                                                                }
                                                                ...
                                                                raicu::globals::settings::target_list["players"].push_back(player_entry);
                                                            }
                                                        }
            ...
            case 5: // Game
                ...
                BeginChild("##game_childs", ImVec2(GetWindowWidth() - 80, GetWindowHeight() - 80));
                {
                    switch (custom.m_game_subtab) {
                        case 0: // Main
                            custom.begin_child("Loading Screen##1", ImVec2(GetWindowWidth() / 2 - GetStyle().ItemSpacing.x / 2, GetWindowHeight()));
                            {
                                TextDisabled("DISABLED FOR NOW");
